...
{
    /// <summary>
    /// Find a return the closest parent to a given object with a certain tag
    /// </summary>
    /// <param name="childObject">Object to traverse</param>
    ...
    //Draws just the box at where it is currently hitting.
     ...
     public static void DrawPath(List<NavNode> path, Color colour, float duration)
     {
         foreach (NavNode node in path)
         {
             DrawBox(new Box(node.worldPosition, 0.125f * Vector3.one, Quaternion.identity), colour, duration);
         }
     }

     public static Vector2 XZVector(Vector3 v)
     {
